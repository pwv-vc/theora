    ...
    <footer class="border-t border-zinc-800 bg-zinc-900 mt-auto relative z-[20000]">
      <div class="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0 mb-6 sm:mb-8">
          ...
          <a href="https://github.com/pwv-vc/theora" target="_blank" rel="noopener noreferrer" class="text-zinc-400 hover:text-[var(--color-accent)] transition-colors self-start sm:self-auto" title="View on GitHub">
            <GitHubIcon size={20} />
          </a>
        </div>

        {/* Bottom section: PWV logo and Copyright (under the border) */}
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-6 sm:pt-8 border-t border-zinc-800">
